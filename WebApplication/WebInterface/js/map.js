...
// Focus on NYC by default
  ...
  map.data.loadGeoJson('http://137.116.214.6:8080/location/'+latitude+'/'+longitude); 
  ...
  map.data.addListener('click', function(event) {
    ...
    if(event.feature.getProperty("cultural")!="None"){
      displayDetail = event.feature.getProperty("cultural");
    }
    if(event.feature.getProperty("parks")!="None"){
      displayDetail = event.feature.getProperty("parks");
    }
    if(event.feature.getProperty("leisure")!="None"){
      displayDetail = event.feature.getProperty("leisure");
    }
    if(event.feature.getProperty("nightlife")!="None"){
      displayDetail = event.feature.getProperty("nightlife");
    }
    if(event.feature.getProperty("sport")!="None"){
      displayDetail = event.feature.getProperty("sport");
    }

    if(event.feature.getProperty("name")!="None"){
      $("#span0").text(event.feature.getProperty("name"));
    }
